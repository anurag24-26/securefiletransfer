...
const ForgotPassword = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col gap-8 z-10 right-8 top-1/2 -translate-y-1/2 hidden md:flex opacity-80">
        <motion.img
          src={rightImage1}
          className="w-32 h-32"
          alt="right1"
        ...
        {successAnim && (
          ...
          >
            <motion.img
              ...
              className="w-52 h-52 md:w-64 md:h-64 mb-4"
            />
            <motion.div
            ...
            >
              <HiCheckCircle
                ...
                size={48}
              />
              <h2 className="text-2xl md:text-3xl font-bold text-green-300 drop-shadow">
