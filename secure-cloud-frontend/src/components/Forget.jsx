  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute flex flex-col gap-8 z-10 left-5 md:left-[calc(50%-450px)] top-1/2 -translate-y-1/2 hidden md:flex"
      >
      ...
      <motion.div
        ...
        className="absolute flex flex-col gap-8 z-10 right-5 md:right-[calc(50%-450px)] top-1/2 -translate-y-1/2 hidden md:flex"
      >
        <img src={rightImage1} className="w-36 h-36 opacity-80" alt="right1" />
        <img src={rightImage2} className="w-44 h-44 opacity-80" alt="right2" />
      </motion.div>
      ...
      <motion.div
        ...
        className="relative z-20 w-full max-w-md sm:max-w-sm p-6 sm:p-8
      ...
      >
        <div className="text-center mb-6">
          ...
          >
            <div className="p-3 rounded-full bg-blue-500/20 backdrop-blur-md border border-blue-300/30">
        ...
        {/* Alerts */}
        {message && (
          <div className="text-green-400 bg-green-900/30 border border-green-500/30 rounded-md px-4 py-2 text-sm mb-4 text-center">
            {message}
          </div>
        )}
        {error && (
          <div className="text-red-400 bg-red-900/30 border border-red-500/30 rounded-md px-4 py-2 text-sm mb-4 text-center">
            {error}
          </div>
        )}
