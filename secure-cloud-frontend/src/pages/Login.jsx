  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-grow flex items-center justify-center">
        <div className="w-full max-w-md p-10 sm:p-12 rounded-2xl shadow-2xl border border-white/10 
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-6">
            <div className="space-y-2">
              <label htmlFor="email" className="block text-sm font-medium text-gray-100 mb-1 drop-shadow">
                Email Address
              </label>
              <div className="relative">
                <input
                  ...
                  required
                  className="border border-slate-700/70 bg-slate-900/60 p-3 w-full rounded-lg 
                             text-gray-100 focus:outline-none focus:border-cyan-400 
                             focus:ring-2 focus:ring-cyan-500/40 transition-all duration-200 
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="block text-sm font-medium text-gray-100 mb-1 drop-shadow">
                Password
              </label>
              <div className="relative">
                <input
