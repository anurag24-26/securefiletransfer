// MyOrganization.js — Professional, Fully Responsive Glassmorphic UI
...
const MyOrganization = ({ backgroundImage }) => {
  ...
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/80 via-slate-900/40 to-black/70 backdrop-blur-[2px]" />
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-3xl rounded-[2rem] bg-white/15 backdrop-blur-2xl border border-white/20 shadow-[0_8px_40px_rgba(0,0,0,0.3)] p-5 sm:p-10"
      >
        {/* Header */}
        <motion.div
        ...
        {loading && (
          <div className="flex flex-col items-center mt-10">
            <span className="h-10 w-10 sm:h-12 sm:w-12 border-4 border-indigo-400 border-b-transparent rounded-full animate-spin"></span>
            <span className="text-gray-100 mt-3 animate-pulse text-sm sm:text-lg">
          ...
          >
            ...
            <div className="flex justify-center sm:justify-end">
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-pink-500 via-red-400 to-orange-400 text-white font-semibold rounded-full px-4 sm:px-6 py-2 text-sm sm:text-base shadow-md hover:shadow-pink-500/40 transform hover:scale-[1.03] transition-all"
              >
            ...
            {/* Info Card */}
            <div className="rounded-3xl border border-white/20 bg-white/25 backdrop-blur-2xl p-5 sm:p-6 shadow-lg hover:shadow-indigo-400/40 transition-all">
                  ...
                  {org.admins?.length > 0 ? (
                    org.admins.map((admin) => (
                      <motion.div
                        ...
                        className="flex flex-col sm:flex-row sm:items-center justify-between bg-gradient-to-r from-indigo-50 via-blue-50 to-teal-50 rounded-xl px-3 sm:px-4 py-2 shadow-sm hover:scale-[1.02] transition"
                      >
        ...
        {!loading && !org && !err && (
          <motion.form
            ...
            className="mt-10 bg-white/20 backdrop-blur-2xl rounded-3xl p-5 sm:p-8 space-y-5 border border-white/30 shadow-2xl hover:shadow-indigo-400/40 transform hover:scale-[1.02] transition-all"
          >
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-indigo-500 via-teal-500 to-blue-500 hover:from-blue-600 hover:via-indigo-500 hover:to-teal-500 text-white font-bold text-base sm:text-lg py-3 rounded-full shadow-lg transform hover:scale-[1.05] transition-all"
            >
              Join
            </button>
          </motion.form>
